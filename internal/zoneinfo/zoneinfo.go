...
func (l *Location) lookup(sec int64) (name string, offset int, start, end int64, isDST bool) {
	...
	if lo == len(tx)-1 && l.extend != "" {
		if ename, eoffset, estart, eend, eisDST, ok := tzset(l.extend, start, end, sec); ok {
...
// parse succeeded.
func tzset(s string, initStart, initEnd, sec int64) (name string, offset int, start, end int64, isDST, ok bool) {
	var (
	...
	if len(s) == 0 || s[0] == ',' {
		...
		return stdName, stdOffset, initStart, omega, false, true
	}
