...
var httpGetStatusCodeOnly = values.NewFunction(
	"get",
...
var httpPostOrig = values.NewFunction(
	"post",
	semantic.NewFunctionPolyType(semantic.FunctionPolySignature{
		Parameters: map[string]semantic.PolyType{
			"url":     semantic.String,
...
func init() {
	flux.RegisterPackageValue("http", "post", httpPostOrig)
	flux.RegisterPackageValue("http", "get", httpGetStatusCodeOnly)
