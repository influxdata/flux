...
,,1,metric_name,source-value-10,source-value-10,1
,,1,metric_name,source-value-10,source-value-10,2

#datatype,string,long,string,string,string,double
#group,false,true,true,true,true,false
#default,_result,,,,,
,result,table,_field,src,dst,_value
,,1,metric_name,source-value-20,source-value-20,3
,,1,metric_name,source-value-20,source-value-20,4
"
