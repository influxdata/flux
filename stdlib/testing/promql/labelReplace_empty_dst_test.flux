...
#group,false,true,true,true,false
#default,_result,,,,
,result,table,_field,src,_value
,,1,metric_name,source-value-10,1
,,1,metric_name,source-value-10,2

#datatype,string,long,string,string,double
#group,false,true,true,true,false
#default,_result,,,,
,result,table,_field,src,_value
,,1,metric_name,source-value-20,3
,,1,metric_name,source-value-20,4
"
