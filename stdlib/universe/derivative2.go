...
func newDerivativeTransformation2(id execute.DatasetID, spec *DerivativeProcedureSpec, mem memory.Allocator) (execute.Transformation, execute.Dataset, error) {
	tr := &derivativeTransformation2{
...
func (t *derivativeTransformation2) Process(chunk table.Chunk, state interface{}, d *execute.TransportDataset, mem memory.Allocator) (interface{}, bool, error) {
...
func (t *derivativeTransformation2) processChunk(chunk table.Chunk, state *derivativeState, d *execute.TransportDataset, mem memory.Allocator) (*derivativeState, error) {
...
func (t *derivativeTransformation2) timeMask(ts *array.Int, d *derivativeState, mem memory.Allocator) (*memory.Buffer, error) {
	if ts.NullN() > 0 {
...
// the given group key.
func (t *derivativeTransformation2) initializeState(chunk table.Chunk) (*derivativeState, error) {
...
// present originally.
func (t *derivativeTransformation2) reconcileState(chunk table.Chunk, state *derivativeState) error {
	for _, col := range chunk.Cols() {
...
func (t *derivativeTransformation2) initializeColumnState(col flux.ColMeta, state *derivativeState) error {
...
func (t *derivativeTransformation2) derivativeStateFor(col flux.ColMeta, state *derivativeState) (derivativeColumnState, error) {
