...
testcase range_nsecs_group_sum {
    ...
    want =
        array.from(rows: [{_value: 9.0, section: "1a"}, {_value: 13.2, section: "2b"}])
            |> group(columns: ["_field", "_measurement", "section"])
...
testcase range_nsecs_window_sum {
    ...
    want =
        array.from(
            rows: [
                {
                    _start: 2021-01-01T00:00:01.000000005Z,
                    _stop: 2021-01-01T00:00:01.00000001Z,
                    _value: 7.0,
                },
                {
                    _start: 2021-01-01T00:00:01.00000001Z,
                    _stop: 2021-01-01T00:00:01.00000002Z,
                    _value: 11.0,
                },
                {
                    _start: 2021-01-01T00:00:01.00000002Z,
                    _stop: 2021-01-01T00:00:01.00000003Z,
                    _value: 12.44,
                },
            ],
        )
