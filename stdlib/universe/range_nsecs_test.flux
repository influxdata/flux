...
testcase range_nsecs_bare_last {
    input = array.from(
        ...
        |> testing.load()
    want = array.from(rows: [{_time: 2021-01-01T00:00:01.000000005Z, _field: "foo", _value: 3.0, _measurement: "mm"}, {_time: 2021-01-01T00:00:01.000000011Z, _field: "bar", _value: 5.0, _measurement: "mm"}])
        |> group(columns: ["_field", "_measurement"])
    got = input
...
testcase range_nsecs_bare_max {
    input = array.from(
        ...
        |> group(columns: ["_field", "_measurement"])
        |> testing.load()
    want = array.from(rows: [{_time: 2021-01-01T00:00:01.000000005Z, _field: "foo", _value: 3.0, _measurement: "mm"}, {_time: 2021-01-01T00:00:01.000000015Z, _field: "bar", _value: 6.0, _measurement: "mm"}])
        |> group(columns: ["_field", "_measurement"])
    got = input
...
testcase range_nsecs_group_max {
    input = array.from(
        rows: [
            {
                _time: 2021-01-01T00:00:01.000000001Z,
                _field: "foo",
                _value: 1.0,
                _measurement: "mm",
                section: "1a",
            ...
            {
                _time: 2021-01-01T00:00:01.000000002Z,
                _field: "foo",
                _value: 2.0,
                _measurement: "mm",
                section: "2b",
            ...
            {
                _time: 2021-01-01T00:00:01.000000005Z,
                _field: "foo",
                _value: 3.0,
                _measurement: "mm",
                section: "1a",
            ...
            {
                _time: 2021-01-01T00:00:01.000000024Z,
                _field: "foo",
                _value: 11.24,
                _measurement: "mm",
                section: "1a",
            ...
            {
                _time: 2021-01-01T00:00:01.000000009Z,
                _field: "bar",
                _value: 4.0,
                _measurement: "mm",
                section: "2b",
            ...
            {
                _time: 2021-01-01T00:00:01.000000011Z,
                _field: "bar",
                _value: 5.0,
                _measurement: "mm",
                section: "1a",
            ...
            {
                _time: 2021-01-01T00:00:01.000000015Z,
                _field: "bar",
                _value: 6.0,
                _measurement: "mm",
                section: "2b",
            ...
            {
                _time: 2021-01-01T00:00:01.000000022Z,
                _field: "bar",
                _value: 1.2,
                _measurement: "mm",
                section: "2b",
            ...
            {
                _time: 2021-01-01T00:00:01.000000031Z,
                _field: "bar",
                _value: 0.28,
                _measurement: "mm",
                section: "1a",
        ...
        |> group(columns: ["_field", "_measurement"])
        |> testing.load()
    want = array.from(rows: [{_value: 5.0, _time: 2021-01-01T00:00:01.000000011Z, section: "1a"}, {_value: 4.0, _time: 2021-01-01T00:00:01.000000009Z, section: "2b"}])
...
testcase range_nsecs_group_sum {
    ...
    want = array.from(rows: [{_value: 9.0, section: "1a"}, {_value: 13.2, section: "2b"}])
        |> group(columns: ["_field", "_measurement", "section"])
...
testcase range_nsecs_group_last {
    ...
    want = array.from(rows: [{_value: 5.0, _time: 2021-01-01T00:00:01.000000011Z, section: "1a", _field: "foo"}, {_value: 1.2, _time: 2021-01-01T00:00:01.000000022Z, section: "2b", _field: "foo"}])
        |> group(columns: ["_field", "_measurement", "section"])
...
testcase range_nsecs_window_sum {
    ...
    want = array.from(rows: [{_start: 2021-01-01T00:00:01.000000005Z, _stop: 2021-01-01T00:00:01.00000001Z, _value: 7.0}, {_start: 2021-01-01T00:00:01.00000001Z, _stop: 2021-01-01T00:00:01.00000002Z, _value: 11.0}, {_start: 2021-01-01T00:00:01.00000002Z, _stop: 2021-01-01T00:00:01.00000003Z, _value: 12.44}])
...
testcase range_nsecs_window_first {
    ...
    want = array.from(rows: [{_time: 2021-01-01T00:00:01.000000001Z, _value: 1.0, section: "1a"}, {_time: 2021-01-01T00:00:01.000000011Z, _value: 5.0, section: "1a"}, {_time: 2021-01-01T00:00:01.000000022Z, _value: 1.2, section: "1a"}])
        |> group(columns: ["_field", "_measurement", "section"])
...
testcase range_nsecs_agg_last {
    ...
    want = array.from(rows: [{_time: 2021-01-01T00:00:01.000000009Z, _value: 3.0, _field: "foo", section: "1a"}, {_time: 2021-01-01T00:00:01.000000014Z, _value: 5.0, _field: "bar", section: "1a"}, {_time: 2021-01-01T00:00:01.000000014Z, _value: 4.0, _field: "bar", section: "2b"}, {_time: 2021-01-01T00:00:01.000000019Z, _value: 6.0, _field: "bar", section: "2b"}])
        |> group(columns: ["_field", "_measurement", "section"])
