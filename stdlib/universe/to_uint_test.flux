...
,,1,2018-05-22T19:53:16Z,18446744073709551615.132412412,k1,m
...
,,1,2018-05-22T19:52:00Z,2030-01-01T00:00:00Z,2018-05-22T19:53:16Z,k1,m,9223372036854775808
...
"
t_to_uint = (table=<-) => table
    |> range(start: 2018-05-22T19:52:00Z)
    |> toUInt()

test _to = () => ({input: testing.loadStorage(csv: inData), want: testing.loadMem(csv: outData), fn: t_to_uint})
