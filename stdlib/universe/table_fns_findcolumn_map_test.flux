...
"
t_table_fns_findcolumn_map = (table=<-) => table
...
test _table_fns_findcolumn_map = () => ({input: testing.loadStorage(csv: inData), want: testing.loadMem(csv: outData), fn: t_table_fns_findcolumn_map})
