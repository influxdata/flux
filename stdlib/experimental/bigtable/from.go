...
func (r BigtableFilterRewriteRule) Rewrite(ctx context.Context, filter plan.Node, nextNodeId *int) (plan.Node, bool, error) {
...
func (r BigtableLimitRewriteRule) Rewrite(ctx context.Context, limit plan.Node, nextNodeId *int) (plan.Node, bool, error) {
