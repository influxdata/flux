...
testcase prometheus_histogramQuantile_v2 {
    inData = "#group,false,false,true,true,false,false,true,true
...
"
    outData = "#group,false,false,true,true,true,true,false,true,false,true
...
testcase prometheus_histogramQuantile_v1 {
    inData = "#group,false,false,true,true,false,false,true
...
"
    outData = "#group,false,false,true,true,true,false,true,false,true
