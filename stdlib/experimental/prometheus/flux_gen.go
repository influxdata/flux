		...
		Body: []ast.Statement{&ast.BuiltinStatement{
			...
			BaseNode: ast.BaseNode{
				...
				Loc: &ast.SourceLocation{
					...
					File:   "prometheus.flux",
					Source: "histogramQuantile = (tables=<-, field, quantile) => \n    tables\n        |> filter(fn: (r) => r._measurement == \"prometheus\" and r._field == field)\n        |> group(mode: \"except\", columns: [\"le\", \"_value\"]) \n        |> map(fn:(r) => ({r with le: float(v:r.le)})) \n        |> universe.histogramQuantile(quantile: quantile)",
					Start: ast.Position{
						Column: 1,
						Line:   12,
					},
								...
								Call: &ast.CallExpression{
									Arguments: []ast.Expression{&ast.ObjectExpression{
										BaseNode: ast.BaseNode{
											...
											Loc: &ast.SourceLocation{
												...
												File:   "prometheus.flux",
												Source: "fn: (r) => r._measurement == \"prometheus\" and r._field == field",
												Start: ast.Position{
													Column: 19,
													Line:   14,
												},
											...
											Value: &ast.FunctionExpression{
												BaseNode: ast.BaseNode{
													...
													Loc: &ast.SourceLocation{
														...
														File:   "prometheus.flux",
														Source: "(r) => r._measurement == \"prometheus\" and r._field == field",
														Start: ast.Position{
															Column: 23,
															Line:   14,
														},
												...
												Body: &ast.LogicalExpression{
													BaseNode: ast.BaseNode{
														...
														Loc: &ast.SourceLocation{
															...
															File:   "prometheus.flux",
															Source: "r._measurement == \"prometheus\" and r._field == field",
															Start: ast.Position{
																Column: 30,
																Line:   14,
															},
									...
									BaseNode: ast.BaseNode{
										...
										Loc: &ast.SourceLocation{
											...
											File:   "prometheus.flux",
											Source: "filter(fn: (r) => r._measurement == \"prometheus\" and r._field == field)",
											Start: ast.Position{
												Column: 12,
												Line:   14,
											},
							...
							Call: &ast.CallExpression{
								Arguments: []ast.Expression{&ast.ObjectExpression{
									BaseNode: ast.BaseNode{
										...
										Loc: &ast.SourceLocation{
											...
											File:   "prometheus.flux",
											Source: "mode: \"except\", columns: [\"le\", \"_value\"]",
											Start: ast.Position{
												Column: 18,
												Line:   15,
											},
								...
								BaseNode: ast.BaseNode{
									...
									Loc: &ast.SourceLocation{
										...
										File:   "prometheus.flux",
										Source: "group(mode: \"except\", columns: [\"le\", \"_value\"])",
										Start: ast.Position{
											Column: 12,
											Line:   15,
										},
