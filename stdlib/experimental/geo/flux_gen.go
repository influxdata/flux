								...
								Call: &ast.CallExpression{
									Arguments: []ast.Expression{&ast.ObjectExpression{
										BaseNode: ast.BaseNode{
											...
											Loc: &ast.SourceLocation{
												...
												File:   "geo.flux",
												Source: "fn: (key) => exists key.s2cellID",
												Start: ast.Position{
													Column: 20,
													Line:   28,
												},
											...
											Value: &ast.FunctionExpression{
												BaseNode: ast.BaseNode{
													...
													Loc: &ast.SourceLocation{
														...
														File:   "geo.flux",
														Source: "(key) => exists key.s2cellID",
														Start: ast.Position{
															Column: 24,
															Line:   28,
														},
									...
									BaseNode: ast.BaseNode{
										...
										Loc: &ast.SourceLocation{
											...
											File:   "geo.flux",
											Source: "tableFind(fn: (key) => exists key.s2cellID)",
											Start: ast.Position{
												Column: 10,
												Line:   28,
											},
							...
							Consequent: &ast.CallExpression{
								...
								BaseNode: ast.BaseNode{
									...
									Loc: &ast.SourceLocation{
										...
										File:   "geo.flux",
										Source: "getLevel(token: _r0.s2cellID)",
										Start: ast.Position{
											Column: 7,
											Line:   32,
										},
												...
												Alternate: &ast.CallExpression{
													Arguments: []ast.Expression{&ast.ObjectExpression{
														BaseNode: ast.BaseNode{
															...
															Loc: &ast.SourceLocation{
																...
																File:   "geo.flux",
																Source: "value: getParent(token: r.s2cellID, level: _grid.level), set: _grid.set",
																Start: ast.Position{
																	Column: 20,
																	Line:   72,
																},
														...
														Properties: []*ast.Property{&ast.Property{
															BaseNode: ast.BaseNode{
																...
																Loc: &ast.SourceLocation{
																	...
																	File:   "geo.flux",
																	Source: "value: getParent(token: r.s2cellID, level: _grid.level)",
																	Start: ast.Position{
																		Column: 20,
																		Line:   72,
																	},
															...
															Value: &ast.CallExpression{
																Arguments: []ast.Expression{&ast.ObjectExpression{
																	BaseNode: ast.BaseNode{
																		...
																		Loc: &ast.SourceLocation{
																			...
																			File:   "geo.flux",
																			Source: "token: r.s2cellID, level: _grid.level",
																			Start: ast.Position{
																				Column: 37,
																				Line:   72,
																			},
																...
																BaseNode: ast.BaseNode{
																	...
																	Loc: &ast.SourceLocation{
																		...
																		File:   "geo.flux",
																		Source: "getParent(token: r.s2cellID, level: _grid.level)",
																		Start: ast.Position{
																			Column: 27,
																			Line:   72,
																		},
													...
													BaseNode: ast.BaseNode{
														...
														Loc: &ast.SourceLocation{
															...
															File:   "geo.flux",
															Source: "contains(value: getParent(token: r.s2cellID, level: _grid.level), set: _grid.set)",
															Start: ast.Position{
																Column: 11,
																Line:   72,
															},
												...
												Consequent: &ast.CallExpression{
													Arguments: []ast.Expression{&ast.ObjectExpression{
														BaseNode: ast.BaseNode{
															...
															Loc: &ast.SourceLocation{
																...
																File:   "geo.flux",
																Source: "value: r.s2cellID, set: _grid.set",
																Start: ast.Position{
																	Column: 20,
																	Line:   70,
																},
													...
													BaseNode: ast.BaseNode{
														...
														Loc: &ast.SourceLocation{
															...
															File:   "geo.flux",
															Source: "contains(value: r.s2cellID, set: _grid.set)",
															Start: ast.Position{
																Column: 11,
																Line:   70,
															},
															...
															Properties: []*ast.Property{&ast.Property{
																BaseNode: ast.BaseNode{
																	...
																	Loc: &ast.SourceLocation{
																		...
																		File:   "geo.flux",
																		Source: "_s2cellIDxxx: getParent(point: {lat: r.lat, lon: r.lon}, level: level)",
																		Start: ast.Position{
																			Column: 16,
																			Line:   122,
																		},
								...
								Call: &ast.CallExpression{
									Arguments: []ast.Expression{&ast.ObjectExpression{
										BaseNode: ast.BaseNode{
											...
											Loc: &ast.SourceLocation{
												...
												File:   "geo.flux",
												Source: "columns: { _s2cellIDxxx: newColumn }",
												Start: ast.Position{
													Column: 19,
													Line:   124,
												},
									...
									BaseNode: ast.BaseNode{
										...
										Loc: &ast.SourceLocation{
											...
											File:   "geo.flux",
											Source: "rename(columns: { _s2cellIDxxx: newColumn })",
											Start: ast.Position{
												Column: 12,
												Line:   124,
											},
								...
								Call: &ast.CallExpression{
									Arguments: []ast.Expression{&ast.ObjectExpression{
										BaseNode: ast.BaseNode{
											...
											Loc: &ast.SourceLocation{
												...
												File:   "geo.flux",
												Source: "column: \"s2cellID\", as: newColumn",
												Start: ast.Position{
													Column: 19,
													Line:   117,
												},
									...
									BaseNode: ast.BaseNode{
										...
										Loc: &ast.SourceLocation{
											...
											File:   "geo.flux",
											Source: "duplicate(column: \"s2cellID\", as: newColumn)",
											Start: ast.Position{
												Column: 9,
												Line:   117,
											},
