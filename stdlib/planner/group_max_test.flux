...
"
    ...
    testing.diff(got: result, want: testing.loadMem(csv: out_max_bare))
}
...
"
    ...
    testing.diff(got: result, want: testing.loadMem(csv: out_max_window))
}
...
"
    ...
    testing.diff(got: result, want: testing.loadMem(csv: out_max_agg_window))
}
...
"
    ...
    testing.diff(got: result, want: testing.loadMem(csv: out_max_agg_window_empty))
}
