...
// We cannot use mock flags.
    option debug.features = {aggregateTransformationTransport: true, queryConcurrencyLimit: 1}
    ...
    got =
        array.from(
            rows: [
                {
                    aggregateTransformationTransport: string(v: debug.feature(key: "aggregateTransformationTransport")),
