...
//
// ## Parameters
// - url: (Required) Zenoss [router endpoint URL](https://help.zenoss.com/zsd/RM/configuring-resource-manager/enabling-access-to-browser-interfaces/creating-and-changing-public-endpoints).
// - username: (Required) Zenoss username to use for HTTP BASIC authentication.
//   Default is "" (no authentication).
// - password: (Required) Zenoss password to use for HTTP BASIC authentication.
//   Default is "" (no authentication).
...
//   Default is "".
// - severity: (Required) [Event severity level](https://help.zenoss.com/zsd/RM/administering-resource-manager/event-management/event-severity-levels).
//   Supported values:
//   - Critical
//   - Warning
//   - Info
