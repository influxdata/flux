...
// defaultParseMode TODO
option defaultParseMode = "MarkdownV2"
// defaultDisableWebPagePreview  TODO
option defaultDisableWebPagePreview = false
// defaultSilent TODO
option defaultSilent = true

// message sends a single message to a Telegram channel
// using the API descibed in https://core.telegram.org/bots/api#sendmessage.
// 
// ## Parameters
// 
// - url: - string - URL of the telegram bot endpoint.
//   Defaults to: "https://api.telegram.org/bot"
// - token: - string - Telegram bot token string,
//   such as 123456789:AAxSFgij0ln9C7zUKnr4ScDi5QXTGF71S.
//   Required 
...
// endpoint creates a factory function that creates a target function
// for pipeline `|>` to send messages to telegram for each table row.
// 
// ## Parameters
// 
...
// - parseMode: - string - Parse mode of the message text
//   per https://core.telegram.org/bots/api#formatting-options . Defaults to "MarkdownV2"
// - disableWebPagePreview: - bool - Disables preview of web links in the sent messages when "true".
//   Defaults to "false"
