...
testcase time_location {
    ...
    got = array.from(rows: [{_value: date.time(t: 2021-03-01T00:00:00Z)}])
...
testcase duration_location {
    ...
    want = array.from(rows: [{_value: 2021-03-01T06:30:00Z}, {_value: 2021-04-09T06:30:00Z}])
    got = array.from(rows: [{_value: date.time(t: 1h)}, {_value: date.time(t: 1mo1w1d1h)}])
