	...
	testCases := []struct {
		...
		},
		{
			...
			node: &semantic.FunctionExpression{
				Defaults: &semantic.FunctionDefaults{
					List: []*semantic.FunctionParameterDefault{{Key: &semantic.Identifier{Name: "a"}, Value: &semantic.StringLiteral{Value: "hi"}}},
				},
