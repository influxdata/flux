...
func (c DynamicType) MarshalJSON() ([]byte, error) {
	type Alias DynamicType
	raw := struct {
		Type string `json:"type"`
		Alias
	}{
...
func (c *DynamicType) UnmarshalJSON(data []byte) error {
	type Alias DynamicType
	raw := struct {
		*Alias
	}{}
