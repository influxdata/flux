...
pub fn get_json_documentation(flux_identifier: &str) -> JsValue {
    ...
    for i in &d {
        ...
        if flux_identifier == i.name {
            ...
            doc = JsValue::from_serde(&serde_json::to_vec(&i.values).unwrap()).unwrap();
        }
    }
