...
fn test_object_expression_with_source_locations_and_errors() {
    ...
    let serialized = serde_json::to_string(&n).unwrap();
    expect_test::expect![[r#"{"type":"ObjectExpression","location":{"file":"foo.flux","start":{"line":1,"column":1},"end":{"line":1,"column":13}},"properties":[{"type":"Property","location":{"file":"foo.flux","start":{"line":1,"column":2},"end":{"line":1,"column":12}},"errors":[{"msg":"an error"}],"key":{"type":"Identifier","location":{"file":"foo.flux","start":{"line":1,"column":2},"end":{"line":1,"column":3}},"name":"a"},"value":{"type":"StringLiteral","location":{"file":"foo.flux","start":{"line":1,"column":5},"end":{"line":1,"column":12}},"errors":[{"msg":"an error"},{"msg":"another error"}],"value":"hello"}}]}"#]].assert_eq(&serialized);
