//! Defines the salsa database used to drive compilation
#![allow(missing_docs)] // salsa generates some spurious missing docs errors
...
/// The result type for db errors
pub type Result<T, E = Error> = std::result::Result<T, E>;

/// Errors generated by the compiler
#[derive(Error, Clone, Debug, Eq, PartialEq)]
pub enum Error {
    /// All the errors generated by a single file
    #[error("{0}")]
    FileError(#[from] Arc<FileErrors>),

    /// Some other error which only has a error message
    #[error("{0}")]
    Message(String),
}
