...
testingTest(name: "drop_non_existent", load: testLoadData, infile: "drop_fn.in.csv", outfile: "drop_non_existent.out.csv", test: drop_fn)
testingTest(name: "drop_non_existent",
